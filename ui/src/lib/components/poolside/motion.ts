...
export function reducedMotion(): boolean {
	...
	// to opt in. Lite mode counts too: frozen water means parked rAF loops.
	if (!!document.querySelector('.ps-root.reduce')) return true;
	return !!document.querySelector('.ps-root.lite');
}
