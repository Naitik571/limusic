...
- **Layouts & themes** — Grove, Canopy, plus a Poolside beta; signature looks (Midnight, Aurora, Mono, Canopy Light, Catppuccin) with wash intensity, true black, Sharp/Soft geometry and artwork follow, plus font overrides, ambient mode and Canvas loops
