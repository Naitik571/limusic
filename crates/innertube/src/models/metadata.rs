...
mod tests {
        ...
        let root = json!({
            ...
            "actions": [{ "openPopupAction": { "popup": { "multiPageMenuRenderer": { "sections": [{
                "activeAccountHeaderRenderer": {
                    ...
                    "navigationEndpoint": { "browseEndpoint": { "browseId": "UCSANITIZEDPERSONAL" } }
                }
            }] } } } }]
        });
    ...
    fn parses_one_selectable_identity() {
        let root = json!({
            "responseContext": { "mainAppWebResponseContext": { "datasyncId": "personal-sync||device-sync" } },
                ...
                "accountSectionListRenderer": {
                    ...
                    "contents": [{ "accountItemSectionRenderer": { "contents": [
                        { "accountItem": {
                            ...
                            "channelHandle": { "runs": [{ "text": "@personal" }] },
                            "accountPhoto": { "thumbnails": [{ "url": "https://example.invalid/personal.jpg" }] },
                            "isSelected": true,
                            "hasChannel": true,
                            "navigationEndpoint": { "browseEndpoint": { "browseId": "UCSANITIZEDPERSONAL" } },
                            "serviceEndpoint": { "selectActiveIdentityEndpoint": {
                                "supportedTokens": [
                                    { "datasyncIdToken": { "datasyncIdToken": "personal-sync||ignored-device-part" } }
                                ]
                            } }
                        } }
                    ] } }]
    ...
    fn parses_multiple_identities_and_keeps_a_persisted_non_default_choice() {
        let root = json!({
            "responseContext": { "mainAppWebResponseContext": { "datasyncId": "default-sync||device-sync" } },
            "actions": [{ "getMultiPageMenuAction": { "menu": { "multiPageMenuRenderer": { "sections": [{
                "accountSectionListRenderer": {
                    "header": { "googleAccountHeaderRenderer": {
                        "email": { "runs": [{ "text": "listener@example.invalid" }] }
                    ...
                    "contents": [{ "accountItemSectionRenderer": { "contents": [
                        { "accountItem": {
                            ...
                            "hasChannel": true,
                            "serviceEndpoint": { "selectActiveIdentityEndpoint": {
                                "supportedTokens": [{ "datasyncIdToken": { "datasyncIdToken": "default-sync" } }]
                            } }
                        } },
                        { "accountItem": {
                            "accountName": { "runs": [{ "text": "Brand channel" }] },
                            "channelHandle": { "runs": [{ "text": "@brand" }] },
                            "accountPhoto": { "thumbnails": [{ "url": "https://example.invalid/brand.jpg" }] },
                            "isSelected": false,
                            "hasChannel": true,
                            "navigationEndpoint": { "browseEndpoint": { "browseId": "UCSANITIZEDBRAND" } },
                            "serviceEndpoint": { "selectActiveIdentityEndpoint": {
                                "supportedTokens": [{ "pageIdToken": { "pageId": "brand-page-id" } }]
                            } }
                        } }
                    ] } }]
                }
                ...
                "accountSectionListRenderer": {
                    "contents": [{ "accountItemSectionRenderer": { "contents": [
                        { "accountItem": {
                            ...
                            "serviceEndpoint": { "selectActiveIdentityEndpoint": {
                                "supportedTokens": [
                                    { "datasyncIdToken": { "datasyncIdToken": "minimal-sync" } }
                                ]
                            } }
                        } }
                    ] } }]
    ...
    fn malformed_or_unusable_identity_tokens_are_not_selectable() {
        let root = json!({
            "responseContext": { "mainAppWebResponseContext": { "datasyncId": "active-response-sync||device-sync" } },
            "actions": [{ "getMultiPageMenuAction": { "menu": { "multiPageMenuRenderer": { "sections": [{
                "accountSectionListRenderer": {
                    "contents": [{ "accountItemSectionRenderer": { "contents": [
                        { "accountItem": {
                        ...
                        { "accountItem": {
                            ...
                            "serviceEndpoint": { "selectActiveIdentityEndpoint": {
                                "supportedTokens": [{ "datasyncIdToken": { "datasyncIdToken": "||" } }]
                            } }
                        } },
                        { "accountItem": {
                            "accountName": { "runs": [{ "text": "Fallback token" }] },
                            "serviceEndpoint": { "selectActiveIdentityEndpoint": {
                                "supportedTokens": [{ "datasyncIdToken": { "datasyncIdToken": "||fallback-sync" } }]
                            } }
                        } },
                        { "accountItem": {
                            ...
                            "hasChannel": false,
                            "serviceEndpoint": { "selectActiveIdentityEndpoint": {
                                "supportedTokens": [{ "pageIdToken": { "pageId": "must-not-be-used" } }]
                            } }
                        } }
                    ] } }]
                }
