...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // Phase 2 extraction stack: cipher webview behind the orchestrator; PoToken now runs
            // BotGuard outside the webview (rustypipe-botguard, own thread) so WEB_REMIX actually
            // plays. The fork keeps the yt-dlp fallback wired in below.
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::prune_missing_downloads,
